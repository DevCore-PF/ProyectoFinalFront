...
export default function PayoutBatchManagement({ onCountChange }: PayoutBatchManagementProps) {
  ...
  if (batches.length === 0) {
    return (
      <div className="bg-background2/40 border border-slate-700/50 rounded-xl p-16 text-center">
        ...
        <p className="text-slate-400 text-lg font-medium mb-2">No hay lotes de pago creados</p>
  ...
  return (
    <div>
      <h2 className="text-xl font-semibold text-font-light mb-6">Gestión de Lotes de Pago</h2>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    <h3 className="text-lg font-semibold text-font-light">{professorName}</h3>
                ...
                <div className="flex items-center gap-4">
                  <div className="text-right">
                    ...
                    <p className="text-xl font-bold text-emerald-300">${totalAmount.toFixed(2)}</p>
                  </div>
                  <HiChevronDown
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {batch.status === "PAID" && batch.referenceNumber && (
                            <span className="text-slate-400 text-xs">Ref: {batch.referenceNumber}</span>
                          )}
                        </div>
                      </div>
                        ...
                        <div className="ml-4">
                          {selectedBatch === batch.payoutId ? (
                            <div className="bg-slate-800/50 rounded-lg p-4 min-w-[300px]">
                              <p className="text-slate-300 text-sm mb-2 font-medium">Número de referencia</p>
                              <input
                                type="text"
