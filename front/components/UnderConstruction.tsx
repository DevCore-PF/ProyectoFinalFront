        ...
        <div className="max-w-2xl mx-auto text-center space-y-8">
          <div className="space-y-4">
            ...
            <h2 className="text-4xl md:text-5xl font-title font-bold text-font-light mb-4">
              Página en
              <span className="bg-linear-to-r from-button to-accent-medium bg-clip-text text-transparent ml-3">
                Construcción
              </span>
            </h2>
            <p className="text-lg md:text-xl text-font-light/80 font-body max-w-lg mx-auto">
              Estamos trabajando duro para traerte algo increíble. ¡Vuelve
              pronto!
            </p>
          </div>
          ...
          <div className="bg-background2/20 border border-border-light/30 rounded-xl p-6 backdrop-blur-sm">
            <p className="text-font-light/90 font-body text-lg">
              <span className="text-accent-light font-semibold">DevCore</span>{" "}
              está codificando intensamente...
            </p>
          ...
          <div className="space-y-3">
            <p className="text-font-light/80 text-sm font-body">
              Progreso estimado:
            </p>
            <div className="w-full bg-background2/40 rounded-full h-3 border border-border-light/20">
              <div
                className="bg-linear-to-r from-button to-accent-medium h-full rounded-full relative overflow-hidden"
                style={{ width: "75%" }}
              >
                <div className="absolute inset-0 bg-linear-to-r from-transparent via-white/20 to-transparent animate-pulse"></div>
              </div>
            </div>
            <p className="text-accent-light text-sm font-body">
              75% completado
            </p>
          </div>
