  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mt-8 sm:mt-12">
      {memberships.map((plan, index) => (
        <div
          key={index}
          className={`relative bg-slate-800/40 backdrop-blur-sm border rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:transform hover:scale-[1.02] flex flex-col ${
            plan.popular
        ...
        >
          ...
          <div className="flex-1 flex flex-col">
            ...
            <button
              ...
              className={`w-full font-semibold py-2.5 sm:py-3 text-sm sm:text-base rounded-lg transition-all duration-300 mt-auto ${
                plan.popular
