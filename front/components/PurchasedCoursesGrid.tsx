    ...
    <div className="bg-[#1e1e2e] border border-slate-700/50 rounded-xl overflow-hidden hover:border-slate-600/50 transition-all duration-300 hover:shadow-lg hover:shadow-[#3f4273]/20">
      ...
      <div className="relative p-6 pb-4">
        <div className="flex items-center justify-between mb-4">
          <div className={`bg-gradient-to-br ${config.iconGradient} p-3 rounded-xl shadow-lg w-14 h-14 flex items-center justify-center`}>
      ...
      <div className="px-6 pb-6 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          <span className={`px-2 py-1 rounded-full text-xs font-medium border ${config.badgeColor} ${config.textColor}`}>
            {course.category}
          </span>
        ...
        {totalLessons > 0 && (
          <div className="space-y-2">
            ...
            {/* Lista de lecciones completadas (máximo 3 visibles) */}
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="text-white font-medium">{Math.round(lessonsProgress)}%</span>
          </div>
          <div className="w-full bg-gray-700 rounded-full h-2">
            <div
              className="bg-gradient-to-r from-blue-500 to-purple-600 h-2 rounded-full transition-all duration-300"
    ...
    return (
      <div className={`space-y-6 ${className}`}>
        <div className="text-center py-16 text-slate-400 bg-slate-900/30 rounded-xl border border-slate-700/20">
          ...
          <Link
            href="/courses"
            className="inline-block bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 px-6 py-3 rounded-lg text-white font-medium transition-all duration-300"
          >
            Explorar cursos
          </Link>
        </div>
