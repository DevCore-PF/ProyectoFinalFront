...
const validationSchema = Yup.object({
  ...
  duration: Yup.string()
    ...
    .matches(/^\d+h\s?\d*m?$|^\d+\s?horas?$|^\d+h$/, 'Formato: "4h 30m" o "25h" o "2 horas"'),
  ...
  const formik = useFormik<CreateCourseFormData>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        router.push(`/teacher-dashboard/create-course/${courseResponse.id}/lessons`);
      } catch (error) {
        console.error('Error creating course:', error);
        toastError(error instanceof Error ? error.message : 'Error al crear el curso');
      } finally {
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                {formik.touched.duration && formik.errors.duration && (
                  <p className="text-red-400 text-sm mt-1">{formik.errors.duration}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                `}>
                  ...
                  <span className={`font-medium ${selectedCategoryConfig.textColor}`}>
                    {categoryOptions.find(opt => opt.value === formik.values.category)?.label}
                  </span>
              ...
              {formik.touched.category && formik.errors.category && (
                <p className="text-red-400 text-sm mt-1">{formik.errors.category}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                {formik.touched.difficulty && formik.errors.difficulty && (
                  <p className="text-red-400 text-sm mt-1">{formik.errors.difficulty}</p>
                )}
              </div>
