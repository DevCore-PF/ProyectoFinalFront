...
const HeroSection = () => {
  return (
    <div className="min-h-screen relative overflow-hidden" style={{ background: 'linear-gradient(135deg, var(--color-background) 0%, var(--color-background2) 50%, var(--color-navbar) 100%)' }}>
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex flex-col justify-center items-center px-8 lg:px-16 text-center pt-20">
          ...
          <h1 className="text-white mb-6 leading-[150%] text-center tracking-normal font-medium" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(24px, 4vw, 38px)' }}>
            Con formación online en diseño y desarrollo.
          </h1>

          
          <p className="text-gray-300 mb-8 max-w-2xl text-center font-normal" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(14px, 2vw, 18px)' }}>
            Aprendé con expertos de la industria y forjá las habilidades al siguiente nivel.
          </p>
        ...
        <div className="flex justify-center items-center pb-20 px-8 lg:px-16">
          <div className="flex items-center justify-center gap-20 max-w-7xl w-full">
            ...
            <div className="w-full max-w-md relative z-20">
              ...
              <h2 className="text-white mb-2 font-medium" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(20px, 3vw, 32px)' }}>
                Formate en tecnología.
              </h2>
              <h3 className="text-white mb-6 font-medium" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(20px, 3vw, 32px)' }}>
                Creá tu futuro.
              </h3>
