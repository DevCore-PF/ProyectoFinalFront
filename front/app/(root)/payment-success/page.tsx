          ...
          {showContent && (
            <div className="space-y-6 animate-fadeIn">
              ...
              <div className="space-y-3 md:space-y-4">
                {/* <Link
                  href={"/dashboard"}
                  className="group w-full cursor-pointer bg-button hover:bg-button/80 text-font-light py-4 px-6 rounded-xl font-semibold transition-all duration-300 hover:scale-[1.02] active:scale-95 shadow-lg hover:shadow-purple-500/25 flex items-center justify-center gap-3"
                >
