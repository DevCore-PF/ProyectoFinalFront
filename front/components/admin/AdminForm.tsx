    ...
    <div className="bg-background2/40 border border-slate-700/50 rounded-xl p-6">
      <div className="flex items-center gap-3 mb-6">
        <div className="p-3 bg-amber-500/10 rounded-xl border border-amber-500/20">
          <FaUserShield className="w-6 h-6 text-amber-300" />
        </div>
        <div>
      ...
      <form onSubmit={formik.handleSubmit} className="space-y-5">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className={`w-full h-12 rounded-lg bg-background border px-4 pl-11 text-font-light placeholder-slate-500 focus:outline-none focus:ring-1 transition-all ${
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              className={`w-full h-12 rounded-lg bg-background border px-4 pr-11 text-font-light placeholder-slate-500 focus:outline-none focus:ring-1 transition-all ${
        ...
        <div className="pt-2">
          <button
            ...
            className="w-full bg-button/90 hover:bg-button cursor-pointer transition-all rounded-lg py-3 font-semibold text-font-light disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {formik.isSubmitting ? (
              <>
